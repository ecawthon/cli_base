...
"hi Normal ctermbg=253 ctermfg=Black cterm=NONE guibg=#eaeaea guifg=Black gui=none
...
if has("windows")
  ...
  "hi StatusLineNC ctermbg=DarkGreen ctermfg=bg cterm=NONE guibg=DarkRed guifg=bg gui=none
endif
