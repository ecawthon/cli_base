" Vim color file
"
" Based on Tomas Restrepo's "molokai" theme, which was in turn based on the
" monokai theme for textmate by Wimer Hazenberg and its darker variant by Hamish
" Stuart Macpherson. Modified by Eleanor Cawthon to more closely resemble
" version of Monokai in Sublime Text.
"

" uncomment these if you have trouble - they're commented out becasue they
" interfere with some syntax files and plugins.
" hi clear
set background=dark
" if exists("syntax_on")
"     syntax reset
...
" Diff colors {{{1
if has ("diff")
    hi DiffAdd                       guibg=#273f22
    hi DiffChange                    guibg=#574f22
    hi DiffDelete      guifg=bg      guibg=#572822
