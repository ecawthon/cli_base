...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Special", "22a21f", "", "")
    call <SID>X("SpecialChar", "fb660a", "", "")

    " Syntax Elements
    call <SID>X("String", "0086d2", "", "")
    call <SID>X("Constant", "0086d2", "", "")
    call <SID>X("Delimiter", "aaaaaa", "", "")
    call <SID>X("Number", "0086f7", "", "")
    call <SID>X("Statement", "fb660a", "", "")
    call <SID>X("Operator", "2b6ba2", "", "")
    call <SID>X("Function", "ff0086", "", "")
    call <SID>X("PreCondit", "ff0086", "", "")
    ...
    " Diff
    if has ("diff")
        call <SID>X("DiffAdd", "", "a2d39c", "")
        call <SID>X("DiffChange", "", "cfcfc4", "")
        call <SID>X("DiffDelete", "ffffff", "ffd1dc", "bold")
        call <SID>X("DiffText", "", "fff79a", "italic")
    endif
    ...
    " Tex Highlighting
    call <SID>X("Conceal", "fd8900", "ffffff", "bold")
    call <SID>X("texGreek", "666666", "", "italic")
    call <SID>X("texMathSymbol", "fd8900", "", "")
    " call <SID>X("texStatement", "fd8900", "", "bold")
    call <SID>X("texSubscript", "22a21f", "", "")
    call <SID>X("texSubscripts", "22a21f", "", "")
    call <SID>X("texSuperscript", "22a21f", "", "")
    call <SID>X("texSuperscripts", "22a21f", "", "")
    call <SID>X("texMathZoneA", "AE81FF", "", "")
    call <SID>X("texMathZoneB", "AE81FF", "", "")
    call <SID>X("texMathZoneC", "AE81FF", "", "")
    call <SID>X("texMathZoneD", "AE81FF", "", "")
    call <SID>X("texMathZoneE", "AE81FF", "", "")
    call <SID>X("texMathZoneF", "AE81FF", "", "")
    call <SID>X("texMathZoneG", "AE81FF", "", "")
    call <SID>X("texMathZoneH", "AE81FF", "", "")
    call <SID>X("texMathZoneI", "AE81FF", "", "")
    call <SID>X("texMathZoneJ", "AE81FF", "", "")
    call <SID>X("texMathZoneK", "AE81FF", "", "")
    call <SID>X("texMathZoneL", "AE81FF", "", "")
    call <SID>X("texMathZoneV", "AE81FF", "", "")
    call <SID>X("texMathZoneW", "0086f7", "", "")
    call <SID>X("texMathZoneX", "0086f7", "", "italic")
    call <SID>X("texMathZoneY", "AE81FF", "", "")
    call <SID>X("texMathZoneZ", "AE81FF", "", "")
