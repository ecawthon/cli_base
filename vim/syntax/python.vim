...
" User added - see stackoverflow.com/questions/8312132/vi
" m-editing-the-python-vim-syntax-file-to-highlight-like-textmate
syn region pythonVars start="(" end=")" contained contains=ALL transparent keepend
syn match pythonParameters "[a-zA-Z0-9]" contained skipwhite
